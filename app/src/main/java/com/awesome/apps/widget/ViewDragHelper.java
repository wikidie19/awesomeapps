package com.awesome.apps.widget;
...
public class ViewDragHelper {
     ...
     *
     * @param v View to PaymentInstuctionVersi2 for horizontal scrollability
     ...
     * will return false.
     *
     * @param x X position to PaymentInstuctionVersi2 in the parent's coordinate system
     * @param y Y position to PaymentInstuctionVersi2 in the parent's coordinate system
     ...
     *
     * @param view Child view of the parent to hit PaymentInstuctionVersi2
     * @param x X position to PaymentInstuctionVersi2 in the parent's coordinate system
     * @param y Y position to PaymentInstuctionVersi2 in the parent's coordinate system
